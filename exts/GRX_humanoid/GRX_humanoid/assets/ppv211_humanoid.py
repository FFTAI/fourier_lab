...
PPV211_HUMANOID_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAAC_ASSET_DIR}/Robots/ppv211_noArmCollision.usd",
    ...
    actuators={
        "legs": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                "waist_yaw_joint": 95.47,
                "waist_roll_joint": 108.6,
                "waist_pitch_joint": 108.6,
                ".*_hip_yaw_joint": 95.5,
...
PPV211_HUMANOID_CFG_LOWER = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAAC_ASSET_DIR}/Robots/ppv211_humanoid_lower.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    actuators={
        "legs": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                ".*_hip_yaw_joint": 95,
                ".*_hip_roll_joint": 95,
                ".*_hip_pitch_joint": 366,
                ".*_knee_pitch_joint": 366,
            },
            velocity_limit_sim={
                ".*_hip_yaw_joint": 12.357,
                ".*_hip_roll_joint": 12.362,

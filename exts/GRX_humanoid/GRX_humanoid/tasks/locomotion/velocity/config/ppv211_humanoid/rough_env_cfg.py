...
# Pre-defined configs
##
from GRX_humanoid.assets.ppv211_humanoid import PPV211_HUMANOID_CFG, PPV211_HUMANOID_CFG_LOWER
...
@configclass
class PPV211HumanoidRoughEnvCfg_WBC_FULL(WBCCFG):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.robot = PPV211_HUMANOID_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class PPV211HumanoidRoughEnvCfg_WBC_FULL_Play(PPV211HumanoidRoughEnvCfg_WBC_FULL):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class PPV211HumanoidRoughEnvCfg_WBC_LOWER(LOWERCFG):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.robot = PPV211_HUMANOID_CFG_LOWER.replace(prim_path="{ENV_REGEX_NS}/Robot")
        self.scene.terrain.terrain_generator = SIMPLE_TERRAINS_CFG
...
@configclass
class PPV211HumanoidRoughEnvCfg_WBC_LOWER_Play(PPV211HumanoidRoughEnvCfg_WBC_LOWER):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

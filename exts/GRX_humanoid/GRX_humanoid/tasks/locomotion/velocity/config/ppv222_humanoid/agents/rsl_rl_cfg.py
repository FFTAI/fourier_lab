...
@configclass
class PPV222HumanoidRoughPPORunnerCfg_WBC_LOWER(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 10001
    save_interval = 500
    experiment_name = "ppv222_humanoid_rough_wbc_lower"
...
@configclass
class PPV222HumanoidRoughPPORunnerCfg_WBC_FULL(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 30001
    save_interval = 500
    experiment_name = "ppv222_humanoid_rough_wbc_full"
    empirical_normalization = False
    runner_class = "OnPolicyRunner"
    obs_groups = {
        "policy": ["policy"],

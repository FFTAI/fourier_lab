...
# Pre-defined configs
##
from GRX_humanoid.assets.ppv224_humanoid import PPV224_HUMANOID_CFG, PPV224_HUMANOID_CFG_LOWER
...
@configclass
class PPV224_Mask_WBC(MASK_WBC_CFG):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.robot = PPV224_HUMANOID_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.rewards.minimize_CoT_reward = RewTerm(func=mdp.minimize_CoT_reward,weight = 0.5,params={"std":1.0,"asset_cfg": SceneEntityCfg("robot", joint_names=gr3_lower_joint_names,preserve_order=True)})
...
@configclass
class PPV224_Mask_WBC_Play(PPV224_Mask_WBC):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class PPV224HumanoidRoughEnvCfg_WBC_FULL(WBCCFG):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.robot = PPV224_HUMANOID_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.rewards.upper_joint_stable = RewTerm(func=mdp.joint_vel_stable, weight=0.5, params={"std": 0.3, "asset_cfg": SceneEntityCfg("robot", joint_names=gr3_upper_joint_names,preserve_order=True)})
        self.rewards.upper_joint_total_track = RewTerm(func=mdp.joint_pos_total_track, weight=1.5, params={"std": 0.35, "asset_cfg": SceneEntityCfg("robot", joint_names=gr3_upper_joint_names,preserve_order=True)})
        self.rewards.torso_joint_pos = RewTerm(func=mdp.torso_joint_pos_l2, weight=0.5, params={"std": 0.25, "asset_cfg": SceneEntityCfg("robot", joint_names=gr3_waist_joint_names,preserve_order=True)})
        ...
        self.observations.plot.joint_power = ObsTerm(func=mdp.joint_power,clip=(-100.0, 100.0),params={"asset_cfg": SceneEntityCfg("robot", joint_names=gr3_joint_names,preserve_order=True)})
@configclass
class PPV224HumanoidRoughEnvCfg_WBC_FULL_Play(PPV224HumanoidRoughEnvCfg_WBC_FULL):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class PPV224HumanoidRoughEnvCfg_WBC_LOWER(LOWERCFG):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        self.scene.robot = PPV224_HUMANOID_CFG_LOWER.replace(prim_path="{ENV_REGEX_NS}/Robot")
        self.scene.terrain.terrain_generator = SIMPLE_TERRAINS_CFG
...
@configclass
class PPV224HumanoidRoughEnvCfg_WBC_LOWER_Play(PPV224HumanoidRoughEnvCfg_WBC_LOWER):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()

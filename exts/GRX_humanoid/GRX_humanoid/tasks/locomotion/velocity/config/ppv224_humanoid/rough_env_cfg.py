...
class PPV224HumanoidRoughEnvCfg_WBC_FULL(WBCCFG):
    def __post_init__(self):
        ...
        self.rewards.torso_joint_pos = RewTerm(func=mdp.torso_joint_pos_l2_with_squat, weight=0.5, params={"std": 0.25, "asset_cfg": SceneEntityCfg("robot", joint_names=gr3_waist_joint_names,preserve_order=True)})

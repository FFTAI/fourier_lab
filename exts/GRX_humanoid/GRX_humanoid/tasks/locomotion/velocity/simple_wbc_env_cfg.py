...
class CommandsCfg:
    ...
    height_attitude = mdp.UniformHRCommandCfg(
...
class EventCfg:
    ...
    # scale_all_rigid_body_com_expect = EventTerm(
    #     func=mdp.randomize_rigid_body_com,
    #     mode="startup",
    #     params={"com_range": {"x": (-0.03, 0.03),"y": (-0.03, 0.03),"z": (-0.03, 0.03),},
    #             "asset_cfg": SceneEntityCfg("robot", body_names=["^(?!.*waist_pitch_link).*"]),},
    # )
    # scale_torso_body_com = EventTerm(
    #     func=mdp.randomize_rigid_body_com,
    #     mode="startup",
    #     params={"com_range": {"x": (-0.03, 0.03),"y": (-0.03, 0.03),"z": (-0.03, 0.03),},
    #             "asset_cfg": SceneEntityCfg("robot", body_names=["waist_pitch_link"]),},
...
class RewardsCfg:
    ...
    base_orientation_exp = RewTerm(func=mdp.base_orientation_exp_with_squat, weight=1.0, params={"std": 0.4, "asset_cfg": SceneEntityCfg("robot")})
    torso_orientation_exp = RewTerm(func=mdp.flat_link_rpy_exp, weight=1.0, params={"std": 0.15, "asset_cfg": SceneEntityCfg("robot", body_names="waist_pitch_link")})   
    track_torso_yaw_exp = RewTerm(func=mdp.track_torso_yaw, weight=0., params={"std": 0.25, "asset_cfg": SceneEntityCfg("robot", body_names="waist_pitch_link")})
    track_torso_roll_exp = RewTerm(func=mdp.track_torso_roll, weight=0., params={"std": 0.15, "asset_cfg": SceneEntityCfg("robot", body_names="waist_pitch_link", joint_names="waist_roll_joint")})
    track_torso_pitch_exp = RewTerm(func=mdp.track_torso_pitch, weight=0., params={"std": 0.25, "asset_cfg": SceneEntityCfg("robot", body_names="waist_pitch_link")})
    ...
    foot_alignment = RewTerm(func=mdp.foot_yaw_alignment_reward, weight=0.5,params={"asset_cfg": SceneEntityCfg("robot", body_names=".*foot_roll.*"),"max_angle": 30.0 })
    ...
    torso_vel_xy_world_l2 = RewTerm(func=mdp.body_ang_vel_xy_world_l2, weight=-0.2, params={"asset_cfg": SceneEntityCfg("robot", body_names="waist_pitch_link")})
    ...
    minimize_CoT_reward = RewTerm(func=mdp.minimize_CoT_reward,weight = 1.0,params={"std":0.5,"asset_cfg": SceneEntityCfg("robot", joint_names=".*")}, )
